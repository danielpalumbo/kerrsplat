...
| Large-N self-fit from an over-complete shell (`validation/large_n/shell_selffit.jl`: 300 parcels, hygiene, the true spacetime) | `Fit` | (experiment) χ²/N 6.45 → 1.066 (truth 1.003), 300 → 26 parcels; density PSNR 19.5 → 22.4 dB, temperature and field errors 0.20 and 0.15 (one frequency) | the emissivity recovered, the plasma degenerate at one band |
