...
| FP32 timing (`validation/large_n/bench_precision.jl`, the tails and dual sweep of four batched frames over lists, RTX 2080 SUPER) | `Splats` | (measurement) Float32 9.0× Float64 at 64² × 160 × 300 (6.37 → 0.71 s), 6.0× at 128² × 160 × 600 (24.2 → 4.0 s), image to 1.3e-6; the gradient at fit size finite after the cap's rescaling (`docs/notes/2026-09-12_fp32_transport.md`) | Float64 against Float32 on the card |
