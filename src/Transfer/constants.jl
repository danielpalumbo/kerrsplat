...
const KBOL = 1.3806505e-16        # Boltzmann constant [erg/K]
const GNEWT = 6.6742e-8           # gravitational constant [cgs]
const MSUN = 1.989e33             # solar mass [g]
const PC = 3.085678e18            # parsec [cm]
const JY = 1e-23                  # Jansky [erg/s/cm²/Hz]
