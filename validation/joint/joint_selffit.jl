...
t0 = time()
trace = String[]
qj, xj, hist, acc = Fit.fit_joint!(copy(q), x0, movie, cache, camera; L, iterations, η, warmup, inner, every, nmax, slab, pattern,
