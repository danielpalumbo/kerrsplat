...
@testset "KerrSplat" begin
    ...
    @testset "Geodesics on the CPU backend" begin
        ...
        test_directional_image(CPU(); res = 8, N = 24)
        ...
        test_joint_scans(CPU(); res = 8, N = 40)
        test_gauss_newton(CPU(); res = 8, N = 40)
        test_gain_scans(CPU(); res = 8, N = 40)
    ...
    if CUDA.functional()
        ...
        @testset "Geodesics on CUDA" begin
            ...
            test_joint_scans(CUDABackend(); res = 12, N = 60, label = "CUDA")
            test_directional_image(CUDABackend(); res = 12, N = 60, label = "CUDA")
            test_gauss_newton(CUDABackend(); res = 12, N = 60, label = "CUDA")
            test_gain_scans(CUDABackend(); res = 12, N = 60, label = "CUDA")
